...
.factory('fireBaseData', function($firebase) {
	var ref = new Firebase("https://test-8e51f-default-rtdb.firebaseio.com/"),
    refCart = new Firebase("https://test-8e51f-default-rtdb.firebaseio.com/cart"),
    refUser = new Firebase("https://test-8e51f-default-rtdb.firebaseio.com/users"),
    refCategory = new Firebase("https://test-8e51f-default-rtdb.firebaseio.com/category"),
    refOrder = new Firebase("https://test-8e51f-default-rtdb.firebaseio.com/"),
    refFeatured = new Firebase("https://test-8e51f-default-rtdb.firebaseio.com/featured"),
    refMenu = new Firebase("https://test-8e51f-default-rtdb.firebaseio.com/menu");
  return {
    ref: function() {
      return ref;
    },
